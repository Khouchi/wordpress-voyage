...
class DUPX_Bootstrap
{
	...
	const ARCHIVE_FILENAME	 = 'aymen_khouchi_voyage_d65d6eec2e651e605014_20220329101305_archive.zip';
	const ARCHIVE_SIZE		 = '85225049';
	const INSTALLER_DIR_NAME = 'dup-installer';
	const PACKAGE_HASH		 = 'd65d6ee-29101305';
    const SECONDARY_PACKAGE_HASH = '1960643-29101305';
	const VERSION			 = '1.4.4';
